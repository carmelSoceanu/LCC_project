...
def plot_all_regressions_separated(datasets, results, figsize=(13, 7), save=True):
    ...
    plot_regressions(high_r_squared_points, 'Embedding Models Performance Correlations (R² > 0.15)','High')
    
    # Plot regressions for low R²
    plot_regressions(low_r_squared_points, 'Embedding Models Performance Correlations (R² ≤ 0.15)', 'Low')
